...
vi.mock('@/modules/devtools/presentation', () => ({
  EnvHint: () => null,
  LoginEmailHint: () => null,
...
vi.mock('@/modules/demo/presentation', () => ({
...
import { Route as AppBooksIndexRoute } from './app/books/index';
import { Route as LoginRoute } from './login/route';
import { Route as LoginVerifyRoute } from './login/verify.index';
import { Route as ManagerBooksIdRoute } from './manager/books/$id.index';
import { Route as ManagerBooksIndexRoute } from './manager/books/index';
import { Route as ManagerRoute } from './manager/route';
import { Route as ManagerUsersIndexRoute } from './manager/users/index';
