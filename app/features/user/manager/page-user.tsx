...
export const PageUser = (props: { params: { id: string } }) => {
  ...
  const sessionsItems = sessions.data?.pages.flatMap((p) => p.items) ?? [];
                    ...
                    <WithPermission permission={{ session: ['revoke'] }}>
                      <DataListCell className="flex-none">
                        <Button
                          ...
                          variant="secondary"
                          disabled={
                            currentSession.data?.user.id === props.params.id ||
                            !sessionsItems.length
                          }
                        ...
                        <DataListRow>
                          ...
                          <DataListCell>
                            <DataListText className="text-xs text-muted-foreground">
                              Showing {sessionsItems.length} of{' '}
                              {sessions.data?.pages[0]?.total}
                            </DataListText>
                          </DataListCell>
                        </DataListRow>
                      </>
